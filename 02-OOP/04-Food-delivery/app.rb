...
require_relative 'lib/repositories/repository_order'
require_relative 'lib/models/restaurant'


restaurant = Restaurant.new("Macdonald", "San Francisco")
...
controller_order = ControllerOrder.new(repository_order, repository_restaurant, repository_employee, repository_meal)
